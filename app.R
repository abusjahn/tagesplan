...
# WICHTIG: Bitte erstellen Sie eine Datei namens 'mitarbeiter.xlsx'
# im selben Verzeichnis wie diese app.R-Datei.
# Sie sollte mindestens die folgenden Spalten enthalten: 'Name', 'Vorname', 'Status'.
# Beispielinhalt für 'mitarbeiter.xlsx':
# Name      | Vorname   | Status
# ----------|-----------|---------
# Müller    | Anna      | Fest
# Schmidt   | Peter     | Fest
# Meier     | Sabine    | Teilzeit
# Schulz    | Thomas    | Honorar
# Weber     | Laura     | Fest
# Klein     | Jonas     | Fest
# Groß      | Sophie    | Teilzeit
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      dateInput("selected_date",
        label = "Datum:",
        value = Sys.Date(), # Standardwert ist das aktuelle Datum
    ...
    mainPanel(
      fluidRow(
        column(
          ...
          helpText("Klicken Sie in ein Feld der Spalte 'Name' im Dienstplan, um den ausgewählten Mitarbeiter einzufügen. Sie können mehrere Namen in ein Feld einfügen (mit Komma getrennt)."),
        ...
        column(
          width = 4, # ca. 30%
          h4("Mitarbeiterliste"),
          helpText("Klicken Sie auf einen Nachnamen in der Tabelle, um ihn für die Planung auszuwählen. Der Name bleibt in der Liste, um ihn mehrfach zu verwenden."),
